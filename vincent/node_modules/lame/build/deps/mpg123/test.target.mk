...
OBJS := $(obj).target/$(TARGET)/deps/mpg123/test.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(builddir)/libmpg123.node
...
$(builddir)/test.node: LD_INPUTS := $(OBJS) $(builddir)/libmpg123.node
$(builddir)/test.node: TOOLSET := $(TOOLSET)
$(builddir)/test.node: $(OBJS) $(builddir)/libmpg123.node FORCE_DO_CMD
	$(call do_cmd,link)

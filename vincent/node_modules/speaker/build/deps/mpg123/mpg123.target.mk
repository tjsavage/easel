...
OBJS := $(obj).target/$(TARGET)/deps/mpg123/src/libmpg123/compat.o \
...
$(builddir)/libmpg123.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/libmpg123.node: LIBS := $(LIBS)
$(builddir)/libmpg123.node: TOOLSET := $(TOOLSET)
$(builddir)/libmpg123.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(builddir)/libmpg123.node
# Add target alias
.PHONY: mpg123
mpg123: $(builddir)/libmpg123.node
